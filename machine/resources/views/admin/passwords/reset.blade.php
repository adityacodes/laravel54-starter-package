        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.passwordreset.save') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="row justify-content-center form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
