<div class="col-md-3">
    <div class="list-group">
      ...
      <a href="{{route('admin.users')}}" class="list-group-item  {{Route::is('admin.users')? "active": ""}}"> <i class="fa fa-users"></i> Users </a>
      <a href="{{route('admin.profile')}}" class="list-group-item  {{Route::is('admin.profile')? "active": ""}}"><i class="fa fa-user"></i> Profile</a>
      <a href="{{route('admin.settings')}}" class="list-group-item  {{Route::is('admin.settings')? "active": ""}}"><i class="fa fa-users"></i> Settings</a>
    </div>
